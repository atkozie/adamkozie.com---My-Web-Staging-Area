...
$body ="Here is a message from your website!:\n";
...
$from='From: '. $email . "(" . $name . ")" . "\r\n" . 'Bcc: atkozie@gmail.com' . "\r\n";
// sends bcc to alternate address 

//Creates intelligible subject line that shows where it came from
$subject = 'Email from your Afropop Contact Page'; // if your client has more than one web site, you can put the site name here.
...
mail ('atkozie@gmail.com', $subject, $body, $from);

header('Location: thank-you.php'); // replace "thx.html" with the name and path to your actual thank you page